/*
 * gpio_irq_lcd_hd44780.c -> simple template driver
 *
 * GPL
...
#define DRIVER_NAME "gpio_irq_lcd_hd44780"
...
static irqreturn_t
gpio_irq_lcd_hd44780_isr(int irq, void *tmp_data)
{
	SD *data = (SD*) tmp_data;
...
static ssize_t
gpio_irq_lcd_hd44780_write(struct file *instance,
...
static ssize_t
gpio_irq_lcd_hd44780_read(struct file *instance,
...
static int
gpio_irq_lcd_hd44780_open(struct inode *dev_node, struct file *instance)
{
...
static int
gpio_irq_lcd_hd44780_close(struct inode *dev_node, struct file *instance)
{
	SD *data = NULL;
...
static struct file_operations fops = {
	.owner = THIS_MODULE,
	.read = gpio_irq_lcd_hd44780_read,
	.write = gpio_irq_lcd_hd44780_write,
	.open = gpio_irq_lcd_hd44780_open,
	.release = gpio_irq_lcd_hd44780_close
};

static int __init
gpio_irq_lcd_hd44780_init(void)
{
	/* get a device number */
...
static void __exit
gpio_irq_lcd_hd44780_exit(void)
{
...
module_init(gpio_irq_lcd_hd44780_init);
module_exit(gpio_irq_lcd_hd44780_exit);

MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("gpio_irq_lcd_hd44780 - simple template driver");
